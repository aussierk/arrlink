  ...
  const inner = (
    <div className="relative">
      ...
      {/* modal={false}: see CategorySelect.tsx's comment -- the default
          modal inert-trapping breaks mouse interaction on the options list
          when the search input is nested alongside it, and this already
          lives inside a Dialog that traps focus on its own. */}
      <ComboboxOptions
        modal={false}
